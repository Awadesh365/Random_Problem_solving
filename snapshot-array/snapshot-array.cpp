...
public:
    // NM... IDK
    // POD, this was really hard to get and 
    // understand that what exectly i do,
    ...
    // NOTE:- Giving wrong ans when i am using {,} instead of makepair, and also when i am using .second instead of ->second
